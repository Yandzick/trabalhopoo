...
public class AlunoDAO{
    ...
    public void delete(Aluno aluno)
	{
		...
		try {
            ...
            stmt = conexaoBD.prepareStatement(sql) ;
            stmt.executeUpdate();
            System.out.println("[AlunoDAO] Aluno deletado no banco com sucesso!");
		} catch (SQLException e) {
			e.printStackTrace();
		} finally {
			System.out.println(" Fechando conexao!!");
	...
	public void update(Aluno aluno)
	{
		...
		try {
			Connection conexaoBD = null;
	        PreparedStatement stmt = null;
	        String sql =  "UPDATE aluno SET nome='"+aluno.getNome()+"' where matricula=" + aluno.getMatricula()+""
	        conexaoBD = ConnectionFactory.getConnection();
            stmt = conexaoBD.prepareStatement(sql) ;
            stmt.executeUpdate();
            System.out.println("[AlunoDAO] Aluno editado no banco com sucesso!");
